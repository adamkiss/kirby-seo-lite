...
return [
	...
	'default' => [ // default field values for metadata, format is [field => value]
		...
		'lang' => fn (Page $page) => $page->kirby()->language()?->locale(LC_ALL) ?? $page->kirby()->option('adamkiss.seo-lite.lang', 'en_US'),
		...
		'robotsIndex' => function (Page $page) {
			$index = $page->kirby()->option('adamkiss.seo-lite.robots.index');
			...
			return $page->kirby()->option('adamkiss.seo-lite.robots.followPageStatus', true) ? $page->isListed() : true;
		},
		'robotsFollow' => fn (Page $page) => $page->kirby()->option('adamkiss.seo-lite.default.robotsIndex')($page),
		'robotsArchive' => fn (Page $page) => $page->kirby()->option('adamkiss.seo-lite.default.robotsIndex')($page),
		'robotsImageindex' => fn (Page $page) => $page->kirby()->option('adamkiss.seo-lite.default.robotsIndex')($page),
		'robotsSnippet' => fn (Page $page) => $page->kirby()->option('adamkiss.seo-lite.default.robotsIndex')($page),
	],
